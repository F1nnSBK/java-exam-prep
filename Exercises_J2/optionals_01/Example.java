...
public class Example {
  ...
  public static void main(String[] args) {
    ...
    System.out.println((collection.getBookByTitle("Das Lied von Eis und Feuer 5") != null) ? collection.getBookByTitle("Das Lied von Eis und Feuer 5") : "Buch ist nicht vorhanden!");
